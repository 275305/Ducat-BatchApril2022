...
//	
//	@Test(priority = 14)
//	public void ValidatingFranchiseMyOrders()
//	{
//		String username = eu.readData("FranchiseSheet", 11, 3);
//		String password = eu.readData("FranchiseSheet", 11, 5);
//		franchisepage.franchiseMyOrdersAsAutomobileGermShield(username, password);
//	}
	...
	public void ValidatingFranchiseMyOrdersAsFacilityGermShield()
	{
		...
		franchisepage.franchiseMyOrdersAsFacilityGermShield(username, password, enterCatogory, enterArea, enterAddress, enterPincode);
	}
	...
	public void ValidatingFranchiseMyOrdersAsElevatorGermShield()
	{
		...
		String enterAddress = eu.readData("FranchiseSheet", 11, 6);
		String enterPincode = eu.readData("FranchiseSheet", 11, 7);
		franchisepage.franchiseMyOrdersAsElevatorGermShield(username, password, enterCatogory, packageType, enterAddress, enterPincode);
	}
	...
	public void ValidatingFranchiseMyOrdersAsJumpstartService()
	{
		...
		String enterAddress = eu.readData("FranchiseSheet", 11, 6);
		String enterPincode = eu.readData("FranchiseSheet", 11, 7);
		franchisepage.franchiseMyOrdersAsJumpstartService(username, password, enterCatogory, enterAddress, enterPincode);
	}
	...
	public void ValidatingFranchiseMyOrdersAsBigTransport()
	{
		...
		String enterAddress = eu.readData("FranchiseSheet", 11, 6);
		String enterPincode = eu.readData("FranchiseSheet", 11, 7);
		franchisepage.franchiseMyOrdersAsBigTransport(username, password, enterCatogory, enterArea, enterAddress, enterPincode);
	}
}
