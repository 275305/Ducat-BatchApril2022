...
public class HomePage extends SeleniumWrapper {
    ...
    private static final By Click_Germ_Shield_Antimicrobial_Coating= By.xpath("//p[contains(text(),'Germ Shield Antimicrobial Coating')]");
...
//  private static final By =By.xpath("");
    ...
    public void enterDroomFranchise()
    {
    	...
    	System.out.println(WebDriverFactory.getDriver().findElement(Click_Droom_Franchise).getText());
    	verifyByContains(Click_Droom_Franchise, "");
